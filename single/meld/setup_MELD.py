...
# # make sure we have the right replicas
# for i in range(N_REPLICAS):
#     alpha = i / (N_REPLICAS - 1)
#     temperature = s.temperature_scaler(alpha)
#     print(f"Replica {i}: alpha = {alpha}, Temperature = {temperature}")
...
def setup_system():
    ...
    # sphere restraint
    pep_res = list(range(n_res_protein+1, n_res+1))
