...
plt.plot(time_0, distances_0, label=label_0, color='orange')
plt.plot(time_29, distances_29, label=label_29, color='cornflowerblue')
...
plt.xticks(np.arange(0, max(time_0[-1], time_29[-1]) +5, 50))  # Set x-ticks at 0, 30, 60, 90 ps
plt.xlabel('Time (ps)')
