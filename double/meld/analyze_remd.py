...
def alpha_vs_rep(store, args):
    ...
    pyplot.ylabel("α")
    pyplot.title("Alpha versus replica index")
    pyplot.savefig("alpha_vs_rep.png", dpi=300, bbox_inches="tight")
...
def accept_vs_rep(store, args):
    ...
    pyplot.title("Acceptance probability versus replica index")
    pyplot.savefig("accept_vs_rep.png", dpi=300, bbox_inches="tight")
...
def visualize_alpha(store, args):
    ...
    pyplot.xlabel("Step")
    pyplot.ylabel("α")
    pyplot.title("Runner movement through alpha space")
    pyplot.savefig("alpha_plot.png", dpi=300, bbox_inches="tight")
...
def visualize_trace(store, args):
    ...
    pyplot.xlabel("Step")
    pyplot.ylabel("Replica index")
    pyplot.title("Trace of replica through ladder")
    pyplot.savefig("trace_plot.png", dpi=300, bbox_inches="tight")
...
def visualize_fup(store, args):
    ...
    pyplot.plot(f_up, "k-", label="f_up")
    pyplot.plot([0, n_reps - 1], [1, 0], "k--")
    pyplot.plot(f_down, "r-", label="f_down")
    pyplot.plot([0, n_reps - 1], [0, 1], "r--")
    pyplot.xlim(0, n_reps - 1)
    pyplot.xlabel("Replica index")
    pyplot.ylabel("f_up")
    pyplot.title("f_up and f_down")
    pyplot.legend()
    pyplot.savefig("fup_plot.png", dpi=300, bbox_inches="tight")
...
def visualize_accept(store, args):
    ...
    pyplot.title("Acceptance probability for each runner pair")
    pyplot.savefig("acceptance_plot.png", dpi=300, bbox_inches="tight")
